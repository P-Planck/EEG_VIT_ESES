...
def main(args):
    ...
    for epoch in range(args.epochs):
        ...
        # make sure dir model weights exist, if not, create one
        ...
        if epoch % args.save_every == 0:
            torch.save(model.state_dict(), f"./weights_{model_name}/{model_name}_epoch_{epoch}.pth")
            print()

if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument('--model_name', type=str,default="VIT_sinv_4c_pivot")
    ...
    parser.add_argument('--data-path', type=str,default="./EEG_data/EEG_IMG_sinv_pivot_all")
    parser.add_argument('--model-name', default='', help='create model name')

    # 预训练权重路径，如果不想载入就设置为空字符
    # parser.add_argument('--weights', type=str, default='./EEG_run/weights/model-80-3stack.pth',
